...
% Additional values
\newcommand{\sigmaValues} {2.668,     2.903,      0,          0}
...
až \tableValue{\maxValues}{0} FPS. \ul{Nárůst FPS v testu č. \TODO (20) byl na základě metody vnitřních hradeb identifikován jako odlehlé pozorování
...
FPS zjištěných u \tableValue{\rangeValues}{2} testovacích systémů. Průměrný nárůst FPS byl \tableValue{\meanValues}{2} FPS, směrodatná odchylka
pak \tableValue{\sdValues}{2} FPS. U poloviny testovacích cyklů nárůst FPS nepřekročil \tableValue{\medianValues}{2} FPS\@.
