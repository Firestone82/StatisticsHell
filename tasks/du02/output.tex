    ...
    \begin{minipage}{0.94\textwidth}
        ...
        \resizebox{\textwidth}{!}{%
            \begin{tabular}{|p{5cm}|P{3.5cm}|P{3.5cm}|P{8cm}|}
                ...
                \nvidiaCard & \tableValue{\skewnessValues}{2} & \tableValue{\kurtosisValues}{2} & \tableValue{\shapireWilk}{0}              \\ \hline
                \amdCard    & \tableValue{\skewnessValues}{3} & \tableValue{\kurtosisValues}{3} & \tableValue{\shapireWilk}{1}              \\ \hline
            \end{tabular}%
        }
        \vspace{1em}
        ...
        \resizebox{\textwidth}{!}{%
            \begin{tabular}{|p{5cm}|P{5cm}|P{5cm}|P{5cm}|}
                \hline
                            & \textbf{Test symetrie}        & \textbf{Wilcoxon test} & \textbf{SIGN test} \\ \hline
                \nvidiaCard & \tableValue{\symmetryTest}{0} & \lowerThanZero         & ---------          \\ \hline
                \amdCard    & \tableValue{\symmetryTest}{1} & ---------              & \lowerThanZero     \\ \hline
            \end{tabular}%
        }
        \vspace{1em}
        ...
        U grafické karty \nvidiaCard\ lze očekávat, že průměrný nárůst FPS bude přibližně \tableValue{\meanValues}{2}.\@
        ...
        \resizebox{\textwidth}{!}{%
            \begin{tabular}{|p{5cm}|P{4cm}|P{7cm}|P{4cm}|}
                ...
                \nvidiaCard & \tableValue{\meanValues}{2} & \rtxInterval                                      & \lowerThanZero                          \\ \hline
                \amdCard    & \tableValue{\meanValues}{3} & \amdInterval                                      & \lowerThanZero                          \\ \hline
            \end{tabular}%
        }
    \end{minipage}
